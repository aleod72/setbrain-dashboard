...
export function HomeHead() {
    ...
    return <div>
        <h1 className='text-subtitle-mb font-bold text-white-100'>{project && project.name}</h1>
        <p className='text-body-l text-white-48'>😄 Bonjour {profile && profile.firstname} ravie de vous revoir !</p>
    </div>;
}
