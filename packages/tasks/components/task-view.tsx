...
export const TaskView = (async ({taskId}: TaskViewProps) => {
    ...
    return <div className='flex flex-col gap-2 max-w-2xl'>
        ...
        <div className="flex items-center gap-3">
            ...
            {data.assigned_users && <>
            <div className='h-5 w-[1px] bg-white-100'></div><span className='text-body-lm text-white-48'> Vérification :</span>
